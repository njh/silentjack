/*
	...
	Copyright (C) 2006-2026  Nicholas J. Humfrey
...
int main(int argc, char *argv[])
{
    ...
    while ((opt = getopt(argc, argv, "c:n:l:p:P:d:g:vqhr")) != -1) {
        ...
        case 'n':
            ...
            break;
        case 'l':
            silence_theshold = atof(optarg);
            break;
        case 'p':
            silence_period = fabs(atoi(optarg));
            break;
        case 'd':
            nodynamic_theshold = atof(optarg);
            break;
        case 'P':
            nodynamic_period = atof(optarg);
            break;
        case 'g':
            grace_period = fabs(atoi(optarg));
            break;
        case 'v':
            verbose = 1;
            break;
